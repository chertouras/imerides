...
#table1 > thead > tr  {background: #0F0}
#table1 > tbody  >tr:nth-child(odd) {background: #FFF}
...
$('#rightcolumn').css('background','#9c9 ');
  ...
  <p>&nbsp;&nbsp;<a href="<?php echo $logoutAction ?>"><span style="color:#F00; font-size:80%">&#9632;</span>Log out</a><br/>
		       ...
		       <!-- End Left Column -->
		       <!-- Begin Right Column -->
<div id="rightcolumn" style=" width:750px; height:480px ;color:#960 ; float:left; margin-left:11px">
  <p>&nbsp;</p>
<h2 style="font-family:Verdana, Geneva, sans-serif; color:#000;margin-left:10px">Αιτήσεις Συμμετοχής</h2> <br />Σημειώνονται πρώτα οι εκπαιδευτικοί και μετά οι διοικητικοί
<h3>&nbsp;</h3>
...
<table id="tblSearch" width="793" height="61" border="1" class="display" style=" margin-left:00px; color:#000" ><thead>
  <tr align="center" style="background-color:#F00">
